create table company_diversity_info (company_id integer not null AUTO_INCREMENT , company_description varchar(4000), company_name varchar(255), email_id varchar(255), mobile_number varchar(255), urls varchar(255), primary key (company_id)) engine=InnoDB;
